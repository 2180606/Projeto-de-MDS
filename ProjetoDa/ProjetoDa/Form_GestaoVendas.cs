...
namespace ProjetoDa
{
    public partial class Form_GestaoVendas : Form
    {
        private BaseDadosDAContainer container;
        public Form_GestaoVendas(BaseDadosDAContainer containerImp)
        {
            InitializeComponent();
        ...
        {
            Form_AdicionarCarroVenda adicionarCarroVenda = new Form_AdicionarCarroVenda(container);
        ...
        private void ButtonEliminarCarroVenda_Click(object sender, EventArgs e)
        {
            ...
            Form_EliminarCarroVenda eliminarCarroVenda = new Form_EliminarCarroVenda(container);
        ...
        private void ButtonEditarVenda_Click(object sender, EventArgs e)
        {
            ...
            {
                Form_EditarVenda editarVenda = new Form_EditarVenda(container);
