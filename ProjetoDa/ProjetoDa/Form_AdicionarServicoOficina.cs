...
namespace ProjetoDa
{
    public partial class Form_AdicionarServicoOficina : Form
    {
        BaseDadosDAContainer container;
        Cliente clienteSelecionado;
        CarroOficina carroSelecionado;
        public Form_AdicionarServicoOficina(BaseDadosDAContainer containerImp,Cliente cliente,CarroOficina carroOficina)
        {
            InitializeComponent();
